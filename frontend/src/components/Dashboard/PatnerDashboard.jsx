...
const AdminDashboard = () => {
   ...
   const [selectedNotice, setSelectedNotice] = useState({});
    ...
    const data = [
        { title: 'Total Project', value: '100', color: 'linear-gradient(135deg, #f6d365 0%, #fda085 100%)' },
        { title: 'Total Bank Accounts', value: '100', color: 'linear-gradient(135deg, #a1c4fd 0%, #c2e9fb 100%)' },
