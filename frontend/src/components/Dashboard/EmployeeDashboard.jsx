...
const EmployeeDashboard = () => {
   ...
   const [selectedNotice, setSelectedNotice] = useState({});
    ...
    const data = [
        { title: 'Total Projects', value: '100', color: 'linear-gradient(135deg, #f6d365 0%, #fda085 100%)' },
        { title: 'Active Projects', value: '100', color: 'linear-gradient(135deg, #a1c4fd 0%, #c2e9fb 100%)' },
        { 
            title: 'Active Bank Account', 
            value: bankAccount !== undefined ? bankAccount : 'Loading...', 
            color: 'linear-gradient(135deg,rgb(251, 19, 255) 0%, #c2e9fb 100%)' 
        },
        { title: 'Total Member', value: '100', color: 'linear-gradient(135deg, #fbc2eb 0%, #a6c1ee 100%)' },
    ];
    // Static totals
