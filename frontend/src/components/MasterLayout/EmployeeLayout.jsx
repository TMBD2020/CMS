...
const EmployeeLayout = (props) => {
  ...
  const userPhoto = user ? user.photo : logo; 
  ...
  return (
    <Fragment>
      ...
      <div ref={(div) => { sideNavRef = div }} className="side-nav-open border-radius-0 card">
        <NavLink to="/employee" end className="d-flex justify-content-center sticky-top bg-white">
          <img src={logo} className="logo w-25" />
        </NavLink>
        <div className='bg-pannel'>
        <h5 className='text-center mt-1 pannelTitle fs-5'>Employee Pannel</h5>
        </div>
