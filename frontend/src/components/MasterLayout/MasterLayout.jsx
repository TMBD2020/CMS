...
const MasterLayout = (props) => {
  ...
  const superSidebarItems  = [
    ...
    {
      title: 'Sms',
      icon: <MdOutlineSms  className="side-bar-item-icon" />,
      url: '/super',
      subMenu: [
        {
          title: 'Add Notice',
  ...
  return (
    <Fragment>
      ...
      <div ref={(div) => { sideNavRef = div }} className="side-nav-open border-radius-0 card">
        <NavLink to="/super" end className="d-flex justify-content-center sticky-top bg-white">
          <img src={logo} className="logo w-25" />
        </NavLink>
        <div className='bg-pannel'>
        <h5 className='text-center mt-1 pannelTitle fs-5'>Super Pannel</h5>
        </div>
